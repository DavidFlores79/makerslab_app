// ABOUTME: Gamepad robot control module page with dynamic module detail loading and sticky action bar
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(
      builder: (context, state) {
        ...
        if (state.getModuleDetail(GamepadPage.moduleId) == null &&
            !state.isLoadingModuleDetails) {
          context.read<HomeBloc>().add(
            LoadModuleDetail(moduleId: GamepadPage.moduleId),
          );
        }

        final moduleDetail = state.getModuleDetail(GamepadPage.moduleId);
