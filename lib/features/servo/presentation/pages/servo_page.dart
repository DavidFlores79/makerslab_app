// ABOUTME: Servo motor control module page with dynamic module detail loading and sticky action bar
...
class ServoPage extends StatefulWidget {
  ...
  static const String moduleId = 'servo';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(
      builder: (context, state) {
        ...
        if (state.getModuleDetail(ServoPage.moduleId) == null &&
            !state.isLoadingModuleDetails) {
          context.read<HomeBloc>().add(
            LoadModuleDetail(moduleId: ServoPage.moduleId),
          );
        }

        final moduleDetail = state.getModuleDetail(ServoPage.moduleId);
        ...
        return Scaffold(
          ...
          floatingActionButton: AnimatedPadding(
            ...
            child: PxChatBotFloatingButton(
              moduleKey: moduleDetail?.chatModuleKey ?? 'servo',
            ),
          ),
        );
      },
