...
void main() {
  ...
  group('FileSharingRepositoryImpl', () {
    ...
    test(
      'should return Right(null) when service completes successfully',
      () async {
        // Arrange
        final tShareResult = ShareResult('', ShareResultStatus.success);
        when(
          mockService.shareAssetFile(
    ...
    test(
      'should return FileNotFoundFailure when PlatformException contains "Unable to load asset"',
      () async {
        // Arrange
        when(
          mockService.shareAssetFile(
    ...
    test(
      'should return ShareFailure when PlatformException without asset error',
      () async {
        // Arrange
        when(
          mockService.shareAssetFile(
          ...
          PlatformException(code: 'ShareError', message: 'Share failed'),
        );
    ...
    test(
      'should return FileSystemFailure when FileSystemException is thrown',
      () async {
        // Arrange
        when(
          mockService.shareAssetFile(
